...
<section class="section faq" id="faq"><div class="container"><div class="section-head reveal"><div class="eyebrow">08 / Q&amp;A</div><h2 class="serif">ご来店前の、よくあるご質問。</h2><p class="lead">質問を押すと回答が開きます。</p></div><div class="faq-list">${faq}</div></div></section>
